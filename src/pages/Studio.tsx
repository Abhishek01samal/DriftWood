...
import { ArrowUpRight, MapPin, Clock, Users, Award, Hammer, Eye, Heart, Leaf, LucideIcon } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div ref={heroRef} className="h-screen relative overflow-hidden">
        ...
        <motion.div 
          style={{ y: heroY }}
          className="relative z-20 h-full flex flex-col justify-end container mx-auto px-6 lg:px-12 pb-32"
        >
          <motion.span 
          ...
          <motion.h1 
            ...
            className="text-[clamp(3rem,12vw,10rem)] font-bold uppercase leading-[0.85]"
          >
            THE
          </motion.h1>
          <motion.h1 
            ...
            className="text-[clamp(3rem,12vw,10rem)] font-bold uppercase leading-[0.85] text-foreground/30"
          >
            STUDIO
          </motion.h1>
        </motion.div>
      ...
      <MarqueeText text="WHERE ART MEETS CRAFTSMANSHIP" />
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <ScrollReveal direction="left">
              ...
              <h2 className="display-large mb-8">
                A Coastal<br />
                <span className="text-foreground/30">Workshop</span>
              </h2>
      ...
      <section className="relative py-32">
        <div className="absolute inset-0">
          <img src={blogCoastal} alt="Coastal view" className="w-full h-full object-cover" />
          <div className="absolute inset-0 bg-primary/80" />
        </div>
        
        <div className="relative z-10 container mx-auto px-6 lg:px-12 text-center">
          <ScrollReveal>
            <Award size={60} className="text-accent mx-auto mb-8" />
            <h2 className="text-[clamp(2.5rem,6vw,5rem)] font-bold text-primary-foreground mb-6">
              Schedule a Visit
            </h2>
            <p className="text-primary-foreground/70 text-xl max-w-2xl mx-auto mb-10">
              We welcome studio tours by appointment. See our artisans at work, 
              explore our material collection, and discuss your vision in person.
            </p>
            <Link to="/contact">
              <motion.span 
                className="bg-accent text-accent-foreground px-8 py-4 inline-flex items-center gap-2 font-medium"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.98 }}
              >
                Book a Tour
